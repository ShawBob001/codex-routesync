...
import { changeSavedAuthPassphrase, getSavedAuthPassphrase, hasEncryptedSavedFiles, setSavedAuthPassphrase } from "@codex-switchbridge/core";

export const STORAGE_PASSWORD_SECRET_KEY = "codex-switchbridge.savedAuthPassphrase";
