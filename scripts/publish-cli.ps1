...
Commands:
  ...
  check    Validate local npm publish prerequisites for codex-switchbridge-cli.
...
function Invoke-PublishRelease {
    ...
    try {
        ...
        Write-Host "$mode for codex-switchbridge-cli@$targetVersion with npm tag '$publishTag'."
    }
    finally {
        Pop-Location
    }
